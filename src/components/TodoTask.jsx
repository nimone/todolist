...
function TodoTask({ todo, onMark, onRemove, onEdit }) {
  return (
    <li className="flex bg-gray-900/60 backdrop-filter backdrop-blur-sm items-center px-3 py-2 border-b border-white/10 group hover:bg-opacity-65">
      <input
        type="checkbox"
      ...
      <span
        className={`overflow-x-hidden overflow-ellipsis mx-3 ${
          todo.completed ? "text-gray-300 line-through" : "cursor-pointer"
        }`}
